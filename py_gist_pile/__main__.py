...
def main():
    ...
    greeting_provider_service: GreetingProviderService = GreetingProviderServiceImpl(
        date_provider_service
    )
    ...
    LOG.notice(
        f"main(): I will greet you with: {d4l(greeting_provider_service.get_greeting())}"
    )
