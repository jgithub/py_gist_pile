...
.PHONY: test
test:
	cd ${ROOT_DIR} && PYTHONPATH="./py_gist_pile:./py_gist_pile/boolean:./py_gist_pile/date:./py_gist_pile/greeting:./py_gist_pile/llm:./py_gist_pile/json:" LOG_PREPEND_TIMESTAMP=1 LOG_DEBUG=1 python3 -m unittest discover -v
